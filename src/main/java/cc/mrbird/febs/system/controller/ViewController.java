...
public class ViewController extends BaseController {
    ...
    @GetMapping(FebsConstant.VIEW_PREFIX + "getTest")
    public String getTest() {
        return FebsUtil.view("system/test");
    }
     ...
     * @return
     */
    @GetMapping(FebsConstant.VIEW_PREFIX + "diankangqi/fenjiedian")
    public String fenjiedian() {
        return FebsUtil.view("system/electric/fenjiedian");
    }

    @GetMapping(FebsConstant.VIEW_PREFIX + "diankangqi/tiexinzhijing")
    public String tiexinzhijing() {
        return FebsUtil.view("system/electric/tiexinzhijing");
    }

    @GetMapping(FebsConstant.VIEW_PREFIX + "diankangqi/zhudiankang")
    public String zhudiankang() {
        return FebsUtil.view("system/electric/zhudiankang");
    }

    @GetMapping(FebsConstant.VIEW_PREFIX + "diankangqi/shaobeishengwenzu")
    public String shaobeishengwenzu() {
